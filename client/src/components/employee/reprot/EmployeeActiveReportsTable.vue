...
export default {
  name:"activeEmployeeReportsTable",
  components: {},
  data: () => ({
    icons:{
      mdiEye,
  ...
  created() {
    this.initialize()
    this.$store.dispatch('initEmployeeActiveReports',this.$store.getters.getAdmin._id)
  },
  computed: {
    formTitle() {
      return 'Düzenle'
    },
    ...mapGetters({reports: 'getEmployeeActiveReports'}),
  },
